...
class OutputPortBase : public PortBase {
 public:
  ...
  internal::OutputPortPrerequisite GetPrerequisite() const { return DoGetPrerequisite(); }
#endif
 ...
 protected:
  ...
  @param size
    ...
    otherwise ignored. */
  OutputPortBase(internal::SystemMessageInterface* owning_system, internal::SystemId owning_system_id, std::string name,
                 OutputPortIndex index, DependencyTicket ticket, PortDataType data_type, int size);
