 ...
 protected:
  TestLoading2x2IntersectionTrafficLightbook()
    ...
    bulbs.push_back(std::make_unique<Bulb>(
        ...
        kRotation, BulbColor::kYellow, BulbType::kArrow, 3.14,
