...
/// Evaluates whether `lane_range_a` end point is G1 contiguous with `lane_range_b` start point.
///
...
/// be nullptr.
/// @returns True When `lane_range_a` end pose and `lane_range_b` start pose are within `road_geometry`.
/// Otherwise, it returns false.
///
/// linear and angular tolerance in the World Frame.
