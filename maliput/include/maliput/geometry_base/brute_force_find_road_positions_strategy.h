...
/// about the geometry internals by forwarding calls to this functor.
struct BruteForceFindRoadPositionsStrategy {

  /// Walks all the @p rg hierarchy calling `ToLanePosition()` on all lanes.
  ///
  ...
  std::vector<maliput::api::RoadPositionResult> operator()(
