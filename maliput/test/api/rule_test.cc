...
TEST_F(RuleTest, RangeValueRuleConstructor) {
  ...
  EXPECT_NO_THROW(RangeValueRule(kId, kTypeId, kZone, kRelatedRules, kSeverity, kRanges));
  EXPECT_NO_THROW(RangeValueRule(kId, kTypeId, kZone, {} /* related rules */, kSeverity, kRanges));
  ...
  EXPECT_THROW(RangeValueRule(kId, kTypeId, kZone, kDuplicatedRelatedRules, kSeverity, kRanges),
               maliput::common::assertion_error);
  // Empty ranges.
  EXPECT_THROW(RangeValueRule(kId, kTypeId, kZone, {} /* related rules */, kSeverity, {} /* ranges */),
               maliput::common::assertion_error);
  // Duplicated ranges.
  ...
  EXPECT_THROW(RangeValueRule(kId, kTypeId, kZone, {} /* related rules */, kSeverity, kDuplicatedRanges),
               maliput::common::assertion_error);
  ...
  EXPECT_THROW(RangeValueRule(kId, kTypeId, kZone, {} /* related rules */, kSeverity, kShiftedRanges),
               maliput::common::assertion_error);
}
...
TEST_F(RuleTest, RangeValueRuleAccessors) {
  ...
  const RangeValueRule dut(kId, kTypeId, kZone, kRelatedRules, kSeverity, kRanges);
...
TEST_F(RuleTest, DiscreteValueRuleConstructor) {
  ...
  EXPECT_NO_THROW(DiscreteValueRule(kId, kTypeId, kZone, {} /* related rules */, kSeverity, kDiscreteValues));
  EXPECT_NO_THROW(DiscreteValueRule(kId, kTypeId, kZone, kRelatedRules, kSeverity, kDiscreteValues));

  // Duplicated related rules.
  const std::vector<Rule::Id> kDuplicatedRelatedRules{Rule::Id("RuleTypeIdB/RuleIdB"), Rule::Id("RuleTypeIdB/RuleIdB")};
  EXPECT_THROW(DiscreteValueRule(kId, kTypeId, kZone, kDuplicatedRelatedRules, kSeverity, kDiscreteValues),
               maliput::common::assertion_error);
  // Empty discrete values.
  EXPECT_THROW(DiscreteValueRule(kId, kTypeId, kZone, kRelatedRules, kSeverity, {} /* discrete_values */),
               maliput::common::assertion_error);
  // Duplicated ranges.
  const std::vector<std::string> kDuplicatedDiscreteValues{"rule_state_value_1", "rule_state_value_1"};
  EXPECT_THROW(DiscreteValueRule(kId, kTypeId, kZone, kRelatedRules, kSeverity, kDuplicatedDiscreteValues),
               maliput::common::assertion_error);
}
...
TEST_F(RuleTest, DiscreteValueRuleAccessors) {
  ...
  const DiscreteValueRule dut(kId, kTypeId, kZone, kRelatedRules, kSeverity, kDiscreteValues);
