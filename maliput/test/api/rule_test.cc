...
class RuleTest : public ::testing::Test {
 protected:
  ...
  const Rule::RelatedRules kRelatedRules{
      {"RelatedRulesGroup", {Rule::Id("RuleTypeIdB/RuleIdB"), Rule::Id("RuleTypeIdC/RuleIdC")}}};
};
...
TEST_F(RuleTest, RangeValueRuleConstructor) {
  const std::vector<RangeValueRule::Range> kRanges{
      MakeRange(Rule::State::kStrict, kEmptyRelatedRules, "range_description_1", 123. /* min */, 456. /* max */),
      MakeRange(Rule::State::kBestEffort, kEmptyRelatedRules, "range_description_2", 789. /* min */, 1234. /* max */),
  };
  ...
  EXPECT_THROW(RangeValueRule(
                   kId, kTypeId, kZone,
                   {MakeRange(kSeverityInvalid, kRelatedRules, "range_description_1", 123. /* min */, 456. /* max */)}),
  ...
  const std::vector<RangeValueRule::Range> kShiftedRanges{
      MakeRange(Rule::State::kStrict, kEmptyRelatedRules, "range_description_3", 456. /* min */, 123. /* max */)};
...
TEST_F(RuleTest, RangeValueRuleAccessors) {
  const std::vector<RangeValueRule::Range> kRanges{
      MakeRange(Rule::State::kStrict, kEmptyRelatedRules, "range_description_1", 123. /* min */, 456. /* max */),
      MakeRange(Rule::State::kBestEffort, kRelatedRules, "range_description_2", 789. /* min */, 1234. /* max */),
  };
...
GTEST_TEST(RangeTest, EqualOperator) {
  ...
  const RangeValueRule::Range range_2 =
      MakeRange(Rule::State::kStrict, kEmptyRelatedRules, "range_description_1", 456. /* min */, 456. /* max */);
  const RangeValueRule::Range range_3 =
      MakeRange(Rule::State::kStrict, kEmptyRelatedRules, "range_description_1", 123. /* min */, 789. /* max */);
  const RangeValueRule::Range range_4 =
      MakeRange(Rule::State::kStrict, kEmptyRelatedRules, "range_description_4", 123. /* min */, 456. /* max */);
  const RangeValueRule::Range range_5 =
      MakeRange(Rule::State::kBestEffort, kEmptyRelatedRules, "range_description_1", 123. /* min */, 456. /* max */);
...
TEST_F(RuleTest, DiscreteValueRuleConstructor) {
  const std::vector<DiscreteValueRule::DiscreteValue> kDiscreteValues{
      MakeDiscreteValue(Rule::State::kStrict, kEmptyRelatedRules, "rule_state_value_1"),
      MakeDiscreteValue(Rule::State::kBestEffort, kRelatedRules, "rule_state_value_2")};
  ...
  EXPECT_THROW(DiscreteValueRule(kId, kTypeId, kZone,
                                 {MakeDiscreteValue(kSeverityInvalid, kEmptyRelatedRules, "rule_state_value")}),
               maliput::common::assertion_error);
  ...
  const std::vector<DiscreteValueRule::DiscreteValue> kDuplicatedDiscreteValues{
      MakeDiscreteValue(Rule::State::kStrict, kRelatedRules, "rule_state_value_1"),
      MakeDiscreteValue(Rule::State::kStrict, kRelatedRules, "rule_state_value_1")};
...
GTEST_TEST(DiscreteValueTest, EqualOperator) {
  ...
  const DiscreteValueRule::DiscreteValue discrete_value_1 =
      MakeDiscreteValue(Rule::State::kStrict, kEmptyRelatedRules, "value_1");
  const DiscreteValueRule::DiscreteValue discrete_value_2 =
      MakeDiscreteValue(Rule::State::kStrict, kEmptyRelatedRules, "value_2");
  const DiscreteValueRule::DiscreteValue discrete_value_3 =
      MakeDiscreteValue(Rule::State::kBestEffort, kEmptyRelatedRules, "value_1");
