...
class MaliputDragwayLaneTest : public ::testing::Test {
 public:
  ...
  void VerifyBranches(const api::Lane* lane, const RoadGeometry* road_geometry) const {
    ...
    {
      std::optional<api::LaneEnd> default_start_lane_end = lane->GetDefaultBranch(api::LaneEnd::kStart);
      ...
      std::optional<api::LaneEnd> default_finish_lane_end = lane->GetDefaultBranch(api::LaneEnd::kFinish);
