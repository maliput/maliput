...
api::GeoPositionT<drake::AutoDiffXd> Lane::DoToGeoPositionAutoDiff(
  ...
  return {lane_pos.s(),
          lane_pos.r() + drake::AutoDiffXd(Lane::y_offset()),
          lane_pos.h()};
}
...
api::GeoPositionT<drake::symbolic::Expression> Lane::DoToGeoPositionSymbolic(
  ...
  return {lane_pos.s(), lane_pos.r() + drake::symbolic::Expression(Lane::y_offset()),
          lane_pos.h()};
}
...
api::LanePositionT<drake::symbolic::Expression> Lane::DoToLanePositionSymbolic(
  ...
  return ImplDoToLanePositionT<drake::symbolic::Expression>(geo_pos, nearest_point,
                                                     distance);
}
